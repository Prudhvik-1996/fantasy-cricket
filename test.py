...
c = Cricbuzz()
matches = c.matches()
# print(c.scorecard(match[int(id)])['matchinfo']['mchdesc'] + "-" + c.commentary(match[int(id)])['matchinfo']['srs'])
# print(matches) #for pretty prinitng
# for match in matches:
# 	print(match)
			

# print(c.scorecard(matches[0]['id'])['matchinfo']['mchdesc'] + "-" + c.commentary(matches[3]['id'])['matchinfo']['srs'])
# print(matches[2]['matchinfo']['mchstate'])
for i in matches:
	# if i['mchstate']=="preview":
	# print(c.commentary(i['id'])['commentary'])
	print(i)
		# print(c.commentary(i[''4'']))
# print(c.scorecard(matches[2]['id']))
# print(c.commentary(match['id'])['commentary'])
# for match in matches:
# 	print(c.scorecard(match['id']))
	# print(c.commentary(match['id']))
# print((c.livescore(match['id'])))
# print(c.commentary(matches[2]['id']))
# print(c.matchinfo(matches[0]))
